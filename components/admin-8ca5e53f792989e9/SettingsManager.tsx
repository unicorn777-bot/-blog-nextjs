          ...
          <div className="border-t border-slate-200 dark:border-slate-700 pt-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                />
                <label htmlFor="enable_comments" className="text-sm text-slate-700 dark:text-slate-300">
                  启用评论功能
                </label>
              </div>
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                />
                <label htmlFor="comment_moderation" className="text-sm text-slate-700 dark:text-slate-300">
                  评论需要审核
                </label>
              </div>
            </div>
